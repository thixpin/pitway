...
import { checkParallelEligibility } from '../tasks/parallel-eligibility.js';
import { deriveLatestFindingsByRole } from '../reviews/roles.js';
...
// B037: `pitway resume`'s workflow-state assembly, hoisted from
// src/cli/commands/resume.ts so it sits in Core (CLI -> Core -> State/Git):
// reads only .pitway/ and read-only git, never renders. The CLI module keeps
// command registration and the human rendering of this view.
